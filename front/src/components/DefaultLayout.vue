              ...
              <Menu as="div" class="relative ml-3">
                <div class="flex">
                  ...
                  >
                    ...
                    <div class="mx-3">
                      <div v-if="user" class="text-base font-medium leading-none text-left text-white">
                        {{ user.name }}
                      </div>
                      <div v-if="user" class="text-sm font-medium leading-none text-gray-400">
                        {{ user.email }}
                      </div>
                    </div>
                    <svg
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div v-if="user" class="text-base font-medium leading-none text-white">
                {{ user.name }}
              </div>
              <div v-if="user" class="text-sm font-medium leading-none text-gray-400">
                {{ user.email }}
